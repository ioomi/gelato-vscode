...
function createTheme({ scheme, variant, colors: p, namedColors }, definition) {
  ...
  return {
    ...
    colors: {
      ...
      "diffEditor.insertedTextBackground": alpha("base0B", "3A"),
      "diffEditor.removedTextBackground": alpha("base08", "3A"),
      "diffEditor.insertedLineBackground": alpha("base0B", "18"),
      "diffEditor.removedLineBackground": alpha("base08", "18"),
