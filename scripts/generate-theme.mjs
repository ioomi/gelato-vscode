...
function createTheme({ scheme, variant, colors: p, namedColors }, definition) {
  ...
  return {
    ...
    colors: {
      ...
      "editorBracketMatch.background": alpha("base0C", "20"),
      "editorBracketMatch.border": p.base0C,
      ...
      "diffEditor.insertedTextBackground": alpha("base0B", "28"),
      "diffEditor.removedTextBackground": alpha("base08", "28"),
      "diffEditor.insertedLineBackground": alpha("base0B", "14"),
      "diffEditor.removedLineBackground": alpha("base08", "14"),
      "diffEditor.diagonalFill": p.base02,
