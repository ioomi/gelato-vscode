...
Gelato keeps the editor comfortably dark while giving syntax a warm, colorful hierarchy. It ships with four distinct flavors:
...
- **Gelato Vanilla** — a balanced Affogato variant with softened contrast and warm pastel accents.
...
A balanced Affogato variant with gently softened neutrals and warm syntax colors.
...
5. Select **Gelato Sorbet**, **Gelato Affogato**, **Gelato Vanilla**, or **Gelato Soft**.
...
All color palettes live in [`palettes`](./palettes): `default.yaml` is shared by Sorbet and Affogato, while flavor-specific files supply Vanilla and Soft. Theme-specific token rules live in [`theme-definitions`](./theme-definitions), while the generated VS Code theme files are written to [`themes`](./themes).
